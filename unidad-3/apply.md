...
En stack la dirección y el valor están en la misma parte, en cambio los objetos creados en el heap se acceden por un puntero que apunta a la adirección.
...
Este es una referencia a un objeto, sería un puntero que apunta a el punto que esta en la parte de la memorai heap. 
...
<img width="736" height="746" alt="image" src="https://github.com/user-attachments/assets/ba343cea-6025-4296-a7e3-02fed0a5a1b1" />

Veo que ambos tienen la misma dirección que es 0x00000189C05B64D0. Significa que el puntero pHeap está en el stack y guarda la dirección del objeto Punto que está almacenado en el heap.
